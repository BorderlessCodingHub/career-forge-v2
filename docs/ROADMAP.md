...
| [CAR-101](https://linear.app/career-forge-v2/issue/CAR-101) | Epic: Borderless password login — CF stays IdP | — | **Done** — PR #85 · [ADR-008](./decisions/ADR-008-borderless-password-credential-check.md) |
| [CAR-102](https://linear.app/career-forge-v2/issue/CAR-102) | ADR-008 + `IDENTITY_METHOD` on identity-mode | [B] | **Done** — PR #85 |
| [CAR-103](https://linear.app/career-forge-v2/issue/CAR-103) | `users.borderless_user_id` column | [P] | **Done** — PR #85 |
| [CAR-104](https://linear.app/career-forge-v2/issue/CAR-104) | `POST /auth/signin` Borderless proxy | [S] | **Done** — PR #85 |
