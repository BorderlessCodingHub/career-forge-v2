...
Last updated: **2026-08-01** · Last merge: **CAR-25** · prior **CAR-24** · **CAR-23**  
Branch in flight: **CAR-26** (`CAR-26-forge-sse-stream-ticket`) — not merged yet  
...
| CAR-26 | Forge SSE stream ticket | [S] | In Progress — branch `CAR-26-forge-sse-stream-ticket` (local ticket path done; Labs ↔ CAR-21) |
...
| Forge SSE stream ticket | 🔄 In Progress | CAR-26 — branch ready; awaiting merge; Labs SSE still CAR-21 |
