...
Last updated: **2026-08-28** · Last merge: **PR #76** CAR-97 `/learn` figure + callout + quiz (`a5d53a3`) · prior **PR #75** Welcome `$15/mo` / drop `640+` · **PR #74** CAR-96 · **PR #73** Welcome CTA honesty · **PR #72** CAR-95 · Epic **CAR-28** F3b **complete** · Epic **CAR-22** closed  
...
| Canonical skill content (`/learn`) | ✅ Done | CAR-94 — PR #71 attach + `/learn`; CAR-95 — PR #72 five RAG bodies (publish sidecar on desk); CAR-97 — PR #76 figure/callout/quiz parser; next [CAR-98](https://linear.app/career-forge-v2/issue/CAR-98) embeddings body |
