...
Last updated: **2026-08-25** · Last merge: **PR #67** CAR-89 embed allowlist (`6e2fb1e`) · prior **PR #66** CAR-88 · **PR #65** CAR-87 · **PR #64** CAR-86 · Epic **CAR-28** F3b **complete** · Epic **CAR-22** closed  
...
| In-product Reference viewer | ✅ Done | CAR-85 — PR #62 · `/reference?node=&item=`; CAR-86 — PR #64 source card default; CAR-89 — PR #67 operational embed allowlist (`embed_hosts`); `/reference` still uses empty FE constant until CAR-90 ([ADR-007](./decisions/ADR-007-reference-viewer.md)) |
