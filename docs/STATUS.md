...
Last updated: **2026-08-27** · Last merge: **PR #75** Welcome drop `640+` + External **$15/mo** (`dc74d83`) · prior **PR #74** CAR-96 · **PR #73** Welcome CTA honesty · **PR #72** CAR-95 · Epic **CAR-28** F3b **complete** · Epic **CAR-22** closed  
...
| Canonical skill content (`/learn`) | ✅ Done | CAR-94 — PR #71 attach + `/learn`; CAR-95 — PR #72 five RAG bodies (publish sidecar on desk) |
