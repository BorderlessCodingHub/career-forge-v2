...
Last updated: **2026-08-22** · Last merge: **CAR-55** (Tailwind 4 upgrade, PR #45) · prior **CAR-47** (PR #43) · **CAR-46** (PR #42) · **CAR-45** (PR #41) · **CAR-44** (email OTP) · Linear **CAR-55 Done** · **CAR-54 Done** · **CAR-47 Done** · **CAR-46 Done** · **CAR-45 Done** · **CAR-44 Done** · Epic **CAR-22** closed · **F3b** epic **CAR-28** children complete  
...
**Next eng:** **F3a** — [CAR-56](https://linear.app/career-forge-v2/issue/CAR-56) Welcome cutover (Premium B as `/welcome`). [CAR-37](https://linear.app/career-forge-v2/issue/CAR-37) pt-BR · [CAR-36](https://linear.app/career-forge-v2/issue/CAR-36) pilots still open. **F3b** eng complete (CAR-44…47).
...
| [CAR-56](https://linear.app/career-forge-v2/issue/CAR-56) | Welcome cutover: Premium B as `/welcome` | [S] | Backlog — **start next** (unblocked) |
...
**Start order:** CAR-56 (Welcome-as-B) next. CAR-37 → CAR-36 still open. **CAR-33–35 Done** · **CAR-38 Done** · **CAR-39 Done** · **CAR-40 Done** · **CAR-41 Done** · **CAR-34 Done** · **CAR-54 Done** · **CAR-55 Done.**
...
| Email OTP IdP + membership (F3b) | ✅ Done | CAR-44…47 — OTP; membership; paywall; resume email (PR #43) |
| Send resume by email | ✅ Done | CAR-47 — PR #43 · OTP-verified `POST /me/forges/{id}/resume/email` · forge/complete + `/forges` CTAs |
| Entitlement paywall (external) | ✅ Done | CAR-46 — PR #42 · HTTP 402 after free forge; BASE/PSP skip; `ENTITLEMENT_BILLING_ALLOWLIST` until Stripe keys |
...
| Welcome-as-B cutover spec | ✅ Spec locked | CAR-54 — `/welcome` is Premium B; build = CAR-55 TW4 (**Done** PR #45) then CAR-56 port; docs flip on CAR-56; honesty pass = CAR-53 |
