...
No paywall in the membership slice itself. **CAR-57 / ADR-005** enforces Paywall for unpaid `external` **before diagnosis** (and before a new forge). BASE/PSP stay entitled. See [ENTITLEMENT.md](./ENTITLEMENT.md).
