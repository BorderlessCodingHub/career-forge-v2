...
| 0e | overlay | — | `identity-gate-password` | — | ProductEntryGate card (password / OTP / pilot); CF `/auth/signin` when password; product topbar + Welcome-hero backdrop; no `/sign-in` route; Welcome public | Labs ops flag — DEPLOY-LABS-MANUAL §2.5 (CAR-107) |
