...
| 0o | `/operator` | — | `operator-login` / `operator-console` | — | Separate Operator OTP; role-filtered desks; Access card; Content annotations over 40 static IDs with git-body publish guard; no learner/Mentor chrome | Desk polish |
