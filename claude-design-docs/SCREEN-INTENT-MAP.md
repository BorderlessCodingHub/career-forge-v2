...
| 0e | overlay | — | `identity-gate-password` | — | ProductEntryGate password card when `method=borderless_password`; CF `/auth/signin`; no `/sign-in` route; Welcome public | Labs ops flag — DEPLOY-LABS-MANUAL §2.5 (CAR-107) |
