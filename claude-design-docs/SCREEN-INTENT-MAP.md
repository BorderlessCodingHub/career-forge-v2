...
| 0p | `/welcome/plg` | — | `marketing-welcome-plg` | — | EN product-led; forge HTML mock in hero; sticky split-flap plaque; before/during/after; dark tokens; not linked from `/welcome` | Visual polish |
