...
- [ ] Drawer UX polish in HTML prototype — red dismiss **✕**, no duplicate description, accordions (shipped in Next.js; prototype lags)
- [ ] Artifact topbar mentor + trail summary + no page hero duplicate (shipped in Next.js `ArtifactShell`; prototype lags)
