...
export const FaqSection: React.FC<FaqSectionProps> = ({ onOpenStrategyModal }) => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-400 text-base">
            Have questions about cohort schedules, GPU access, or career guarantees? Find instant answers below.
          </p>
        </div>
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            placeholder="Search FAQ (e.g. GPU, time commitment, prerequisites)..."
            ...
            return (
              <div
                ...
                className={`glass-panel rounded-2xl overflow-hidden transition-all border ${
                  isOpen ? 'border-indigo-500/40 bg-slate-900 shadow-xl' : 'border-slate-800 bg-slate-950/80 hover:border-slate-700'
                }`}
              >
                <button
        ...
        <div className="mt-12 text-center bg-slate-900/60 p-6 rounded-2xl border border-slate-800 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-left">
            ...
            <div>
              <div className="text-sm font-bold text-white">Have a unique background question?</div>
              <p className="text-xs text-slate-400">Speak directly with an AI Lead Instructor on a 1-on-1 call.</p>
            </div>
          </div>
          <button
