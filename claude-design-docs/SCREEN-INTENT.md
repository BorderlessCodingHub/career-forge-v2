...
| Preview | Sandboxed iframe only for a domain returned by the authenticated live allowlist GET; allowlisted embeds keep the escape hatch visible and revoke takes effect without deploy |
