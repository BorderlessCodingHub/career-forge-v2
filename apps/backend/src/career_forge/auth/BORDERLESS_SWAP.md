...
| Send resume | [CAR-47](https://linear.app/career-forge-v2/issue/CAR-47) | Email resume link via `POST /me/forges/{id}/resume/email` (OTP-verified only) |
...
Code: `career_forge/auth/providers.py`, `api/auth.py`, `services/otp.py`, `services/mailer.py`, `services/membership.py`, `services/forge_access_tokens.py`.
